...
<template>
  <div style="position: relative;width: 30px;height: 30px;padding-top: 30px;transform: scale(60%)">
    <label class="container">
      <input v-model="darkT" checked="checked" type="checkbox">

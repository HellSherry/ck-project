 ...
 */
@Component
@ServerEndpoint("/public/ws1/ai")
public class WebSokectServer {
     ...
     */
    private static CopyOnWriteArraySet<WebSokectServer> webSockets = new CopyOnWriteArraySet<>();
    /**
     * 用来存在线连接用户信息
     */
    ...
    public void sendAllMessage(String message) {
        ...
        for (WebSokectServer webSocket : webSockets) {
            try {
